...
const createView = fs.readFileSync(path.resolve(scriptPath, '20200601164214-create-view-reabrirfechamento-create.sql'), 'utf8');
const dropView = fs.readFileSync(path.resolve(scriptPath, '20200601164214-create-view-reabrirfechamento-drop.sql'), 'utf8');
