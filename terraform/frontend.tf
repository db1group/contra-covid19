...
[
  {
    ...
    "environment" : [
      ...
      { 
        ...
        "value" : "${var.is_production == true ? "api.${var.hosted_zone}/api" : "${var.environment}-api.${var.hosted_zone}/api"}"
      },
      { 
        "name" : "VUE_APP_KEYCLOAK_URL",
        "value" : "${var.is_production == true ? "auth.${var.hosted_zone}/auth" : "${var.environment}-auth.${var.hosted_zone}/auth"}"
      },
      { 
